...
/* create individual breakdowns general boxes
for ( var i = 0; i< number_of_people; i++ ) {
	$('#people').prepend('<div class="individuals"> <div class="cocktails">cocktails</div> <div class="shots">shots<div> </div>');
}
*/
	
		// writes to canvas
		$('#canvas').html('<div class="words">' + number_of_people + '</div>');
...
/* INPUT total number of cocktails */		
	$('#select_total_cocktails').keyup(function() {
		// figure out which color was chosen
		var number_of_cocktails = $(this).val();
console.log(number_of_cocktails + ' cocktails');
		
		// write recipient to canvas
		$('#canvas').html('<div class="words">' + number_of_cocktails + '</div>');
...
/* INPUT total number of shots */	
	$('#select_total_shots').keyup(function() {
		// figure out which color was chosen
		var number_of_shots = $(this).val();
console.log(number_of_shots + ' shots');
		
		// write recipient to canvas
		$('#canvas').html('<div class="words">' + number_of_shots + '</div>');
